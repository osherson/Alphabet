...
vartitle = "m_{X} (GeV)"
sigregcut = "(trigger_function(766))*(dijetmass>800&jet1tau21<0.6&jet2tau21<0.6&(jet2pmass<130&jet2pmass>90)&(jet1pmass<130&jet1pmass>100)&(jet1bbtag>0.4&jet2bbtag>0.4))"
lumi =2190.
...
for m in mass:
	...
	signal_file= TFile("forLeonardo_Grav_%s_0.root"%(m))
	htrig = signal_file.Get("ct")
	generatedEvents =htrig.GetEntries()
	print(generatedEvents)
	tree = signal_file.Get("myTree") 
	writeplot(tree, Signal_mX, VAR, sigregcut, "(trigger_function(htJet40eta3))")
